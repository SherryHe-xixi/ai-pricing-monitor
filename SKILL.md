...
#### 必须附上的直达链接
每次扫描完成后，**必须**在最终输出中附上以下两组链接：

**飞书多维表格**（完整数据库，含 13 张品类明细表 + 变更记录 + 扫描日志）：
- **多维表格首页**：`https://my.feishu.cn/base/OzoybmkRxaiMl8sBxjUcitpgnVb`
...
**Excel 快照**（全量数据单文件，方便离线查看）：
- **最新版**：`computer:///Users/runxiahe/Documents/Claude/Projects/AI产品PM landing/AI定价监控_最新.xlsx`
